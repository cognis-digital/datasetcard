...
`datasetcard` is a small, self-contained command-line tool from the Cognis suite. It does one job well, runs locally with no account or cloud service required, and is built to be easy to install and read. See the usage below for what it can do.
<!-- cognis:layman:end -->
...
`datasetcard` is source-available (not published to PyPI) — every method below installs
straight from GitHub. Pick whichever you prefer; the one-line scripts auto-detect
the best tool available on your machine.

**One-liner (Linux / macOS):**
```sh
curl -fsSL https://raw.githubusercontent.com/cognis-digital/datasetcard/HEAD/install.sh | sh
```

**One-liner (Windows PowerShell):**
```powershell
irm https://raw.githubusercontent.com/cognis-digital/datasetcard/HEAD/install.ps1 | iex
```

**Or install manually — any one of:**
```sh
pipx install "git+https://github.com/cognis-digital/datasetcard.git"     # isolated (recommended)
uv tool install "git+https://github.com/cognis-digital/datasetcard.git"  # uv
pip install "git+https://github.com/cognis-digital/datasetcard.git"      # pip
```

**From source:**
```sh
git clone https://github.com/cognis-digital/datasetcard.git
cd datasetcard && pip install .
```
