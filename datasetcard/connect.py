"""Native cognis-connect emit for datasetcard — forward findings to any platform.

Maps datasetcard's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    datasetcard ... --format json | datasetcard-emit --to stix
    datasetcard-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
