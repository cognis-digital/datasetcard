"""DATASETCARD core — Auto Dataset Cards / datasheets with Croissant + provenance."""
...
RULES = [
    ("DAT-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("DAT-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("DAT-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
