#!/usr/bin/env sh
# Universal installer for datasetcard. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/datasetcard.git"
echo "Installing datasetcard ..."
...
echo "Done. Run: datasetcard --help"
